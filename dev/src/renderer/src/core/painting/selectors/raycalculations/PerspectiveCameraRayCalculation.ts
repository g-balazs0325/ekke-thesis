import { Euler, Line3, PerspectiveCamera, Quaternion, Vector2, Vector3 } from 'three'
...
{
  calculateCameraRay(camera: PerspectiveCamera, normalizedPosition: Vector2): Line3 {
    ...
    quaternionShift.setFromEuler(
      new Euler(halfFovVert * normalizedPosition.y, halfFovHoriz * normalizedPosition.x, 0)
    )
